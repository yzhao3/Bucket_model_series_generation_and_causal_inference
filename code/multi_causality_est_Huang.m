...
%    err90: standard error at 90% level
%    err95: standard error at 95% level
%    err99: standard error at 99% level
%
% Citations: 
...
var_T21 = (C(1,2) / C(1,1))^2 * var_a12 +  (C(2, 2) - C(1,2)^2/C(1, 1))/C(1,1) *a12^2/N;  % new: add
